...
class NetworkClass {
    ...
    var requestHttpHeaders = NetworkEntity()
    
    var urlQueryParameters = NetworkEntity()
    
    var httpBodyParameters = NetworkEntity()
...
// MARK: - NetworkClass Custom Types
...
extension NetworkClass.CustomError: LocalizedError {
